...
export const MOCK_GUESTS: Guest[] = [
  {
    ...
    allergies: 'Peanuts',
    d1Golf: true,
    d1GolfFlight: 'Flight A-05',
    d2Golf: true,
    d2GolfFlight: 'Flight B-12',
    golfProfileFlags: ['Day1', 'Day2'],
    dinnerProfileFlags: ['Welcome', 'Gala'],
    roomNo: '1201',
    roommate: 'Sato Hiroshi',
    passportLast4: '1234',
    golfTeeOff: '08:00 AM',
    golfFlightNo: 'A-05',
    golfBuggyNo: 'B-12',
    welcomeDinnerTable: 'T08',
    galaDinnerTable: 'V02',
    hotelName: 'Shangri-La KL',
    hotelRoomType: 'Single',
    hotelCheckIn: '27 Mar 2026',
    hotelCheckOut: '01 Apr 2026',
    checkInCount: 0
  }
];
