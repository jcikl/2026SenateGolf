...
const GuestPortal: React.FC<GuestPortalProps> = ({ guest, schedules, packagePermissions, golfGroupings, categoryPermissions }) => {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in duration-500 pb-20 md:pb-0">
      ...
      {/* VIP Identity Header - Premium Green with Orange Accents */}
      <div className="relative h-96 rounded-[40px] overflow-hidden shadow-2xl group border-4 border-[#014227] bg-[#014227]">
        ...
        {/* Gradient Accents - Orange Highlights */}
        <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-[#FFD700]/10 to-[#F58220]/20 rounded-full -mr-32 -mt-32 animate-pulse"></div>
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center p-8 z-10">
          ...
          <div className="bg-[#F58220] px-6 py-1.5 rounded-full mb-4 shadow-lg transform -rotate-1 border border-[#F58220]/20">
            ...
            <div className="flex items-center justify-center space-x-2">
              ...
              {guest.isSenator && (
                <>
                  ...
                  <span className="text-[11px] font-black text-[#F58220] uppercase tracking-widest flex items-center gap-1 bg-[#F58220]/10 px-2 py-0.5 rounded-md border border-[#F58220]/30 shadow-sm">
        ...
        <div className="absolute bottom-0 inset-x-0 h-2 bg-gradient-to-r from-[#FFD700]/20 via-[#F58220]/50 to-[#FFD700]/20 opacity-80"></div>
      </div>
